...
- 📚 Currently in my 1st year exploring **Python, Data Structures, and AI Foundations**.
- 💡 Interested in building **Machine Learning models, Smart Automation tools, and Web Apps**.
- 🎯 Goal: To master AI/ML algorithms and contribute to impactful open-source projects.
- 💬 Ask me about: **Python basics, C/C++ programming, and tech trends**.
